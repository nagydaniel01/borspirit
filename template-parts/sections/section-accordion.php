<?php
    $section_classes = build_section_classes($section, 'accordion');
...
<?php if (!empty($accordion_items)) : ?>
    <section id="<?php echo esc_attr($section_slug); ?>" class="section section--accordion <?php echo esc_attr($section_classes); ?>">
        <div class="container">
