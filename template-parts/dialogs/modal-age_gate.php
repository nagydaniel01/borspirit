        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ageGateModalLabel">
                    <?php printf(
                            esc_html__('Are you over 18 years of age?', TEXT_DOMAIN),
            ...
            <div class="modal-body">
                <p>
                    <?php
                        ...
                        printf(
                            esc_html__('We are committed advocates and supporters of responsible, civilized drinking. Therefore, we do not recommend the consumption of alcoholic beverages to persons under the age of %s and cannot serve them.', TEXT_DOMAIN),
                            esc_html(get_option('ag_min_age', 18))
                        );
                    ?>
                </p>
