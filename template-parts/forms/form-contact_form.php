...
<form id="contact_form" class="form form--contact" method="post" action="<?php echo esc_url( admin_url('admin-ajax.php') ); ?>" novalidate>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="tel" class="form-control" id="<?php echo esc_attr($prefix); ?>phone" name="<?php echo esc_attr($prefix); ?>phone" placeholder="<?php echo esc_attr_x( 'Enter your phone number', 'placeholder', 'borspirit' ); ?>">
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="<?php echo esc_attr($prefix); ?>subject" name="<?php echo esc_attr($prefix); ?>subject" placeholder="<?php echo esc_attr_x( 'Enter subject', 'placeholder', 'borspirit' ); ?>" required aria-required="true">
    </div>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="<?php echo esc_attr($prefix); ?>message" name="<?php echo esc_attr($prefix); ?>message" rows="4" placeholder="<?php echo esc_attr_x( 'Write your message here…', 'placeholder', 'borspirit' ); ?>" required aria-required="true"></textarea>
    </div>
